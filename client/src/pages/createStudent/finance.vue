    ...
    <div class="financial_detail">
      <form class="income form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="col-5 col-sm-12 input-group">
            ...
            <input class="form-input" type="text" id="dad_income">
          </div>
        </div>
        <div class="form-group">
          <div class="col-7 col-sm-12">
          ...
          <div class="col-5 col-sm-12 input-group">
            <span class="input-group-addon">RM</span>
            <input class="form-input" type="text" id="mom_income">
          </div>
        </div>
        <div class="form-group">
          <div class="col-7 col-sm-12">
          ...
          <div class="col-5 col-sm-12 input-group">
            <span class="input-group-addon">RM</span>
            <input class="form-input" type="text" id="guardian_income">
          </div>
        </div>
        <div class="form-group">
          <div class="col-7 col-sm-12">
          ...
          <div class="col-5 col-sm-12 input-group">
            <span class="input-group-addon">RM</span>
            <input class="form-input" type="text" id="other_income">
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="aid-inputs col-12" v-for="i in aidNum" :key="i">
            ...
            <div class="col-5 col-sm-12 input-group">
              ...
              <input class="form-input input-sm" type="text" id="other_aid">
            </div>
          </div>
        </div>
      ...
      <form class="expenditure form-horizontal columns">
        ...
        <div class="form-group">
          ...
          <div class="col-5 col-sm-12 input-group">
            <span class="input-group-addon">RM</span>
            <input class="form-input" type="text" id="food">
          </div>
        </div>
        <div class="form-group">
          <div class="col-7 col-sm-12">
          ...
          <div class="col-5 col-sm-12 input-group">
            <span class="input-group-addon">RM</span>
            <input class="form-input" type="text" id="rent">
          </div>
        </div>
        <div class="form-group">
          <div class="col-7 col-sm-12">
        ...
        <div class="form-group">
          ...
          <div class="col-5 col-sm-12 input-group">
            <span class="input-group-addon">RM</span>
            <input class="form-input" type="text" id="transport">
          </div>
        </div>
        <div class="form-group">
          <div class="col-7 col-sm-12">
          ...
          <div class="col-5 col-sm-12 input-group">
            <span class="input-group-addon">RM</span>
            <input class="form-input" type="text" id="utility">
          </div>
        </div>
        <div class="form-group">
          <div class="col-7 col-sm-12">
          ...
          <div class="col-5 col-sm-12 input-group">
            <span class="input-group-addon">RM</span>
            <input class="form-input" type="text" id="telecomm">
          </div>
        </div>
        <div class="form-group">
          <div class="col-7 col-sm-12">
            <label class="form-label" for="telecomm">医疗费（长期）/惯性疾病治疗费用</label>
          </div>
          <div class="col-5 col-sm-12 input-group">
            <span class="input-group-addon">RM</span>
            <input class="form-input" type="text" id="telecomm">
        ...
        <div class="form-group">
          ...
          <div class="col-5 col-sm-12 input-group">
            <span class="input-group-addon">RM</span>
            <input class="form-input" type="text" id="astro">
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="fee-inputs col-12" v-for="f in feeNum" :key="f">
        ...
        <div class="form-group">
          ...
          <div class="talent-inputs col-12" v-for="t in talentNum" :key="t">
      ...
      <div class="details">
        ...
        <div class="total_income form-group">
          ...
          <div class="col-5 col-sm-12 input-group">
            <span class="input-group-addon">RM</span>
            <span class="form-input" type="text" id="total_income"></span>
          </div>
        </div>
        <div class="total_expenditure form-group">
          ...
          <div class="col-5 col-sm-12 input-group">
            <span class="input-group-addon">RM</span>
            <span class="form-input" type="text" id="total_expenditure"></span>
          </div>
        </div>
        <div class="total_balance form-group">
          ...
          <div class="col-5 col-sm-12 input-group">
            <span class="input-group-addon">RM</span>
            <span class="form-input" type="text" id="total_balance"></span>
          </div>
        </div>
      </div>
